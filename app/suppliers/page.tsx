              ...
              <TableRow key={supplier.id}>
                ...
                <TableCell>
                  <div className="flex gap-2">
                    ...
                    <Button size="sm" color="danger" variant="solid" startContent={<IconTrashX size={15} />} onPress={() => { setEditingSupplier(supplier); setIsDeleteOpen(true); }} style={{ background: "firebrick", color: "white", borderColor: "firebrick" }}>Delete</Button>
                  </div>
                </TableCell>
              </TableRow>
            )}
