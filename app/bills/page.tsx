...
export default function BillsPage() {
  ...
  const buildInvoiceHTML = (inv: InvoiceDetail) => {
    ...
    `).join("");
    const filledCount = inv.invoice_items.length;
    const emptyCount = Math.max(0, 12 - filledCount);
